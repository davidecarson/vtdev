 ...
 *
 *	based on code from Allan Cruse 2008
 *	incorporates MODULE_LICENSE
 *	for Linux kernel version 2.6.
 *
 *	create_proc_read_entry is deprecated.  Need to update to
 *	proc_create for kernel 3.10+
 *----------------------------------------------------------------
 */
